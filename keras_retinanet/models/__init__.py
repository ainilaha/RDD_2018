...
class Backbone(object):
    ...
    def retinanet(self, *args, **kwargs):
        ...
        """
        raise NotImplementedError('RDD_2018 method not implemented.')
...
def backbone(backbone_name):
    ...
    elif "inceptres" in backbone_name:
        from .inception_resnet import InceptionResNet as b
    else:
...
def load_model(filepath, backbone_name='resnet50'):
    """ Loads a RDD_2018 model using the correct custom objects.
...
def convert_model(model, nms=True, class_specific_filter=True, anchor_params=None):
    ...
    Args
        model                 : A RDD_2018 training model.
